# Contribute to bankIO cypress PSD2/OpenBanking API e2e testing

Thank you for your interest in bankIO cypress PSD2/OpenBanking API e2e testing!
...
You can contribute to [bankIO Link](https://bankio.co.uk/bankio-link/) cypress PSD2/OpenBanking API e2e testing in these ways:

- Contribute to code via the [public bankIO developer docs repository](https://github.com/bank-io/bankIO-cypress-api-testing)
- Report documentation bugs via [GitHub Issues](https://github.com/bank-io/bankIO-cypress-api-testing/issues)
...
```cmd
git clone https://github.com/{your user name}/bankIO-cypress-api-testing.git
```

Next, create a reference to the root repository by entering these commands:

```cmd
cd bankIO-cypress-api-testing
git remote add upstream https://github.com/bank-io/bankIO-cypress-api-testing.git
git fetch upstream
```
...
4. Ensure that the Base branch is `bank-io/bankIO-cypress-api-testing@master` and the Head branch is `<your username>/bankIO-cypress-api-testing@<branch name>`.
...
Your pull request will surface on the bank-io/bankIO-cypress-api-testing site under Issues.
...
For example, suppose your local branch X was successfully merged into the bank-io/bankIO-cypress-api-testing master branch and you want to make additional updates to the content that was merged.
Create a new local branch, X2, from the bank-io/bankIO-cypress-api-testing master branch.
